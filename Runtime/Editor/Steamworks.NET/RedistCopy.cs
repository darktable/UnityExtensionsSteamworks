			...
			case BuildTarget.StandaloneWindows:
				{
					...
					CopyFile("steam_api.dll", "steam_api.dll", $"{Utilities.RuntimeDirectory}/x86", pathToBuiltProject);
					break;
				}
			case BuildTarget.StandaloneWindows64:
				{
					baseDir = Path.Combine(Path.GetDirectoryName(pathToBuiltProject), Path.GetFileNameWithoutExtension(pathToBuiltProject) + "_Data");
					CopyFile("steam_api64.dll", "steam_api64.dll", $"{Utilities.RuntimeDirectory}/x86_64", pathToBuiltProject);
					break;
				}
